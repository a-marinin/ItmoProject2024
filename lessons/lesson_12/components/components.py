...
class WebElement:
    ...
    def get_dom_attribute(self, name: str):
        ...
        if value is None:
            return False  # Если у элемента нет заданного атрибута
        if len(value) > 0:
            return value  # Если элемент есть и у него есть заданный аттрибут???
        return True  # Если аттрибут есть, но не у заданного элемента???

    def check_css(self, style, value=''):
        # Возвращает True, если указанный стиль есть у элемента. И False, если указанного стиля у элемента нет.
    ...
    def get_by_type(self):
        # Мульти-поиск (универсальный метод поиска по любому типу локатора)
